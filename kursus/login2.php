...
<div class="login-box">
  ...
  <div class="login-box-body" style="background-color: powderblue;">
    <p class="login-box-msg">Log in Pengajar</p>
    ...
    <form action="" method="post">
      ...
      <div class="row">
        <!-- /.col -->
        <div class="col-xs-5">
          <button type="submit" name="login2" class="btn btn-primary btn-block btn-flat"><i class="glyphicon glyphicon-log-in"></i>    Log In </button>
        </div>
        <!-- /.col -->
      </div>
    </form>
