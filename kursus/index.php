  ...
  <div class="login-box-body" style="background-color: powderblue;">
    ...
    <form action="index2.php" method="post">
      ...
      <div class="row">
        <!-- /.col -->
        <div class="col-xs-5">
          <button type="submit" name="login" class="btn btn-primary btn-block btn-flat"><i class="glyphicon glyphicon-log-in"></i> <a href="index2.php"></a>    Log In </button>
        </div>
        <!-- /.col -->
      </div>
    </form>
