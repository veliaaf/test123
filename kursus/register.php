...
<body class="hold-transition register-page" style="background-image: url('colors.jpg');">
<div class="register-box">
  <div class="register-logo">
    <a href="../index2.html"><b>Admin</b>Here</a>
  </div>

  <div class="register-box-body" style="background-color: powderblue;">
